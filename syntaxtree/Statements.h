...
namespace SyntaxTree {
    ...
    public:
        explicit CompoundStatement(std::vector<std::unique_ptr<const IStatement>>&& _internalStatements, int _line);
    ...
    public:
        AssignmentStatement(std::unique_ptr<const Identifier>&& _leftOperand, std::unique_ptr<const IExpression>&& _rightOperand, int _line);
